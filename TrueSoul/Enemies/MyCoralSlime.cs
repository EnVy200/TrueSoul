...
{
    public class MyCoralSlime : ModNPC
    {
        int FrameX = 0;
        int timePerFrame = 8;
        int MaxFrames = 4;
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.OneFromOptions(45, ModContent.ItemType<GelSword>(), ModContent.ItemType<GelBow>(), ModContent.ItemType<GelDagger>(), ModContent.ItemType<GelPickaxe>(), ModContent.ItemType<GelHamaxe>()));
        }
