...
{
    public class EmeraldLeProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<LimeSparkle>(), Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, Alpha: 128, Scale: 1.2f);
        }
