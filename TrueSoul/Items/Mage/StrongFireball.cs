...
{
    public class StrongFireball : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            if (Projectile.timeLeft <= 0)
            {
                ...
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<WeakFireball>(), 33, 1, Main.myPlayer);
            }
        }
