...
{
    public class WeakFireball : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<OrangeSparkle>(), Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, Alpha: 128, Scale: 0.6f);
