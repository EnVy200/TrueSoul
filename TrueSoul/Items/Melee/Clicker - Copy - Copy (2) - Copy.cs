...
{
    public class ClickerUpgrade4 : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Clicker Five"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(ItemID.PalladiumBar, 26);
