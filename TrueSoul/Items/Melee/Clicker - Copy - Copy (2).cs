...
{
    public class ClickerUpgrade2 : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Clicker Three"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(ItemID.CrimtaneBar, 26);
