...
{
    public class GelEyeball : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Gel Eye"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        ...
        {
            float maxDetectRadius = 570f; // The maximum radius at which a projectile can detect a target
