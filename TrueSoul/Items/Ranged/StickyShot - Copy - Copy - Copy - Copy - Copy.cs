...
{
    public class OnyxCannonBest : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Best Onyx Cannon"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("Shoots FAST and two projectiles that go toward the player and pass them by, it shoots the onyx projectile as well. Does HIGH DAMAGE"); CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 1;
        }
