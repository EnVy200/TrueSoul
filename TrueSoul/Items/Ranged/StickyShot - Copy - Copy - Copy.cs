...
namespace TrueSoul.Items.Ranged
{
    public class OnyxCannon : ModItem
    {
        ...
        {
            DisplayName.SetDefault("The Onyx Cannon"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("Shoots slowly and two projectiles that go toward the player and pass them by, it shoots the onyx projectile as well. Does HIGH DAMAGE"); CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 1;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<OnyxMachine>(), 1);
