...
{
    public class IcyProjectile : ModProjectile
    {
        ...
        {
            target.AddBuff(BuffID.Frostburn, 250, false);
        }
        public override void AI()
        {
            ...
            Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<CyanSparkle>(), 2f, 2f, Alpha: 128, Scale: 1.2f);
            if (Timer == 1)
            {
