...
{
    public class RedPhaseSagi : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Red Phase Sagi"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
