...
{
    public class Sagi : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Sagi"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("A weapon of speed, strength, and prosperity.");
