...
{
    public class SnowySagi : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Snow Covered Sagi"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            Tooltip.SetDefault("Shoots a projectile when dashing.");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<CryoiteBar>(), 26);
