...
namespace TrueSoul.Projectiles.Minions
{
	...
	public class ExampleSimpleMinionBuff : ModBuff
	{
		public override void SetStaticDefaults()
		{
			...
			Description.SetDefault("Obama Care");
	...
	public class ExampleSimpleMinionItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Obama Cylinder");
			Tooltip.SetDefault("Summons an OBAMA to fight for you");
		...
		{
			CreateRecipe()
				.AddIngredient(ModContent.ItemType<Obamium>(), 58)
				.Register();
		}
	}
